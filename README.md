...
-----
OK, mình đã **tái cấu trúc README**, **loại bỏ phần dư / trùng**, và **giữ đúng mức “portfolio-ready” cho Data Analyst / BigQuery SQL project**.  
Bố cục mới tập trung vào **mục tiêu – dữ liệu – truy vấn – insight**, tránh dài dòng, không lặp lại “overview 2 lần”.

Dưới đây là **README.md phiên bản đã chỉnh** ⬇️  
(Bạn có thể copy dùng trực tiếp)
